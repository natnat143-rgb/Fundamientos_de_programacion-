...
if __name__ == "__main__":
    ...
    #¿Que propiedades de la programacion orientada a objeto identifica?
#Tiene herencia pues deja que una clase herede los atributos y métodos de otra.
#Abstracción porque interactua con objetos sin conocer su implementación interna.
#Encapsulamiento porque agrupa datos y comportamientos relacionados dentro de una clase, ocultando los detalles internos. 
